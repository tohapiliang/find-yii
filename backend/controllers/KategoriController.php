...
class KategoriController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            $post = Yii::$app->request->post('Kategori');

            $model->nama_kategori = strtoupper($post['nama_kategori']);
//            var_dump($_POST);die();   //this for debug
            $model->save();
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            $insert = Yii::$app->request->post('Kategori');
            $model->nama_kategori = strtoupper($insert['nama_kategori']);
            $model->save();
            return $this->redirect(['view', 'id' => $model->id_kategori]);
        }
